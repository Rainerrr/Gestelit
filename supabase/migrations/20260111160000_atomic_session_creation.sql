-- Atomic session creation function
-- Eliminates race condition where multiple tabs could create simultaneous sessions
-- by locking, closing existing sessions, and creating new session in single transaction
...
CREATE OR REPLACE FUNCTION create_session_atomic(
  ...
  p_job_item_station_id UUID DEFAULT NULL,
...
BEGIN
  ...
  SELECT jsonb_build_object(
    ...
    'job_item_station_id', s.job_item_station_id,
