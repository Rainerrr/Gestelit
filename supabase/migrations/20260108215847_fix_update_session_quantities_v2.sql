-- Migration: Fix update_session_quantities_atomic_v2() - FOR UPDATE with LEFT JOIN issue
-- Part of: Production Lines + Job Items + WIP feature (Phase 2.2 fix)
...
BEGIN
  ...
  -- Lock and get session first (no join)
  ...
  -- Get step info separately (position and is_terminal)
