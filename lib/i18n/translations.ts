...
export const translations = {
  ...
  "work.actions.finishBlockedProduction": {
    he: "לא ניתן לסיים עבודה בזמן ייצור. יש לשנות סטטוס לפני סיום.",
    ru: "Нельзя завершить работу во время производства. Сначала смените статус.",
  },
